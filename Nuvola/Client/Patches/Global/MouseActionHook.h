#ifndef LUNITY_CLIENT_PATCHES_GLOBAL_MOUSEACTIONHOOK
#define LUNITY_CLIENT_PATCHES_GLOBAL_MOUSEACTIONHOOK
...
#endif /* LUNITY_CLIENT_PATCHES_GLOBAL_MOUSEACTIONHOOK */
