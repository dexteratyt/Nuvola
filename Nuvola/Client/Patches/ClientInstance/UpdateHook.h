#ifndef NUVOLA_CLIENT_PATCHES_CLIENTINSTANCE_UPDATEHOOK
#define NUVOLA_CLIENT_PATCHES_CLIENTINSTANCE_UPDATEHOOK
#include "../IPatch.h"
...
#endif /* NUVOLA_CLIENT_PATCHES_CLIENTINSTANCE_UPDATEHOOK */
