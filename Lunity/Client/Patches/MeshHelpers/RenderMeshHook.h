#ifndef LUNITY_CLIENT_PATCHES_MESHHELPERS_RENDERMESHHOOK
#define LUNITY_CLIENT_PATCHES_MESHHELPERS_RENDERMESHHOOK
#include "../IPatch.h"
...
#endif /* LUNITY_CLIENT_PATCHES_MESHHELPERS_RENDERMESHHOOK */
