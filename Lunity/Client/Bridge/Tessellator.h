...
struct Tessellator {
	...
	auto __thiscall begin(char primitiveMode, int vertCount, char param_4) -> void {
		if(holder_begin == 0) {
		...
		holder_begin += -1;
		return ((void(__thiscall*)(Tessellator*, char primitiveMode, int vertCount, char param_4))holder_begin)(this, primitiveMode, vertCount, param_4);
	};
